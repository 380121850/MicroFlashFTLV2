...
void IIC_Init(unsigned char Slave_Addr)
{
    ...
    IIC_SDA_H;
    IIC_SDA_DIR_OUT;  
    IIC_SCL_H;       //此时SDA=1,SCL=1
    Delay(100);     //上电后，需要适当延时等待IIC准备就绪
}

/******************************************************************************
  函数(模块)名称:void IIC_Start(void)
  功能:	总线启动信号
  输入参数: 无        	              		
  输出参数: 无          	 		   		 
...
/******************************************************************************
  函数(模块)名称:void IIC_Send_Byte(unsigned char Date_Byte)
  功能:	向I2C总线发送一个节字
  输入参数: 要发送的字节        	              		
  输出参数: 无          	 		   		 
  其它说明: 
...
/******************************************************************************
  函数(模块)名称:unsigned char IIC_Receive_Byte(void)
  功能:	从I2C总线接收一个字节
  输入参数: 无        	              		
  输出参数: 接收到的字节          	 		   		 
  其它说明: 
